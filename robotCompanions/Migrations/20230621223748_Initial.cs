    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RobotSize", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    robotSizeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Robot", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Robot_RobotSize_robotSizeId",
                        column: x => x.robotSizeId,
                        principalTable: "RobotSize",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_orderDetails_Robot_robotId",
                        column: x => x.robotId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_orderDetails_robotId",
                table: "orderDetails",
                column: "robotId");

            migrationBuilder.CreateIndex(
                name: "IX_Robot_robotSizeId",
                table: "Robot",
                column: "robotSizeId");
        }
